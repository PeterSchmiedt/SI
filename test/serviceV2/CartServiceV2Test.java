...
public class CartServiceV2Test extends WithApplication {
    ...
    public void setUp() {
        ...
        cartService = new CartServiceImplV2();
    ...
    public void getTotalTest() {
        assertEquals(2500, cartService.getTotal(cart1), delta);
    }

    @Test
    public void getTotalForCategoryTest() {
        assertEquals(16500, cartService.getTotalForCategory(submain), delta);
    }

    @Test
    public void getTotalForDayTest() {
        assertEquals(70000, cartService.getTotalForDay(new Date()), delta);
    }
}
